...
<<<<<<< HEAD
        python_path=r"C:/Users/runneradmin/AppData/Local/Temp/build-env-upg6nged/Scripts/python.exe",
        ...
        # Misc meson settings
        meson_backend="ninja",
        build_dir=r"D:/a/contourpy/contourpy/.mesonpy-a7_qs046/lib/contourpy/util",
=======
...
>>>>>>> 145c46dcb5b19a9082f2e39ee66b3b5564513083
        ...
        # Build options
<<<<<<< HEAD
        build_options=r"-Dbuildtype=release -Db_ndebug=if-release -Db_vscrt=mt '-Dcpp_link_args=['ucrt.lib','vcruntime.lib','/nodefaultlib:libucrt.lib','/nodefaultlib:libvcruntime.lib']' -Dvsenv=True '--native-file=D:/a/contourpy/contourpy/.mesonpy-a7_qs046/meson-python-native-file.ini'",
=======
